...
create_ec2() {
  PRIVATE_IP=$(aws ec2 run-instances \
      ...
      --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=${COMPONENT}}]" "ResourceType=spot-instances,Tags=[{Key=Name,Value=${COMPONENT}}]"  \
